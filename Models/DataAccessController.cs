...
namespace CoursesWebApp.Models
{
    public class DataAccessController
    {
        ...
        private string connectionString = "Server=tcp:coursedatabase017.database.windows.net,1433;Initial Catalog=coursedatabase017;Persist Security Info=False;User ID=azuresql;Password=password;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
